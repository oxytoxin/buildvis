        ...
        <div class="relative pt-18">
            ...
            <div class="container mx-auto px-4 relative">
                <div class="max-w-lg xl:max-w-xl mx-auto mb-12 lg:mb-0 text-center">
                    <h1 class="font-heading text-5xl xs:text-7xl xl:text-8xl tracking-tight mb-8 mt-8">
                    ...
                    <p class="text-lg text-gray-700 mb-10">
                        Why wait months for estimates? BuildVis delivers 3D models and material lists in minutes.
                    </p>
                    @guest
                        <div class="flex flex-col sm:flex-row justify-center">
                            <a href="{{ route('login') }}"
                               class="inline-flex py-4 px-6 mb-3 sm:mb-0 sm:mr-4 items-center justify-center text-lg font-medium text-white hover:text-teal-900 border border-teal-900 hover:border-lime-500 bg-teal-900 hover:bg-lime-500 rounded-full transition duration-200">
                                Start Building
                            </a>
                        ...
                        <div class="flex flex-col sm:flex-row justify-center">
                            @switch(auth()->user()->roles()->first()->name)
                                ...
                                @case('project manager')
                                    <a href="{{ route('filament.project-manager.pages.dashboard') }}"
                                       class="inline-flex py-4 px-6 items-center justify-center text-lg font-medium text-black hover:text-white border border-teal-900 hover:bg-teal-900 rounded-full transition duration-200">
                                        Project Management
                                    </a>
                                    @break
