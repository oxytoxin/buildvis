<div>
    <section x-data="{ mobileNavOpen: false }" class="bg-orange-50">
            ...
            <div class="container mx-auto px-4">
                <div class="relative flex items-center justify-between">
                    ...
                    <ul class="absolute top-1/2 gap-8 left-1/2 transform -translate-x-1/2 -translate-y-1/2 hidden md:flex">
                        ...
                        <li>
                            <a class="inline-block hover:underline text-teal-900 hover:text-teal-700 font-medium"
                               href="{{ route('filament.project-manager.pages.dashboard') }}">
                                Project Management
                            </a>
                        </li>
                        <li>
                    ...
                    <div class="flex items-center justify-end">
                        ...
                        <button x-on:click="mobileNavOpen = !mobileNavOpen"
                                class="md:hidden navbar-burger text-teal-900 hover:text-teal-800">
        ...
        <div class="relative pt-18">
            <img class="hidden md:block absolute top-0 left-0 mt-28 w-32 lg:w-64 rounded-r-2xl"
                 src="https://images.unsplash.com/photo-1561343228-e6a5c693d352?crop=entropy&amp;cs=srgb&amp;fm=jpg&amp;ixid=M3wzMzIzMzB8MHwxfHNlYXJjaHwyNHx8Y29uc3RydWN0aW9ufGVufDB8MXx8fDE3Mzk0Njk2NDF8MA&amp;ixlib=rb-4.0.3&amp;q=85&amp;w=1920"
                 alt="">
            <img class="hidden md:block absolute top-0 right-0 mt-20 lg:w-64 rounded-2xl w-48"
                 src="https://images.unsplash.com/photo-1610551675799-50d4d0fe0252?crop=entropy&amp;cs=srgb&amp;fm=jpg&amp;ixid=M3wzMzIzMzB8MHwxfHNlYXJjaHwzfHxjb25zdHJ1Y3Rpb258ZW58MHwyfHx8MTczOTQ2OTQ3Mnww&amp;ixlib=rb-4.0.3&amp;q=85&amp;w=1920"
                 alt="">
            <div class="container mx-auto px-4 relative">
                <div class="max-w-lg xl:max-w-xl mx-auto mb-12 lg:mb-0 text-center">
                    <h1 class="font-heading text-5xl xs:text-7xl xl:text-8xl tracking-tight mb-8 mt-8">From Vision to
                        Reality</h1>
                    ...
                    <p class="text-lg text-gray-700 mb-10">Why wait months for estimates? BuildVis delivers 3D models
                        and material lists in minutes.</p>
                    @guest
                        <div class="flex flex-col sm:flex-row justify-center">
                            <a href="{{ route('login') }}"
                               class="inline-flex py-4 px-6 mb-3 sm:mb-0 sm:mr-4 items-center justify-center text-lg font-medium text-white hover:text-teal-900 border border-teal-900 hover:border-lime-500 bg-teal-900 hover:bg-lime-500 rounded-full transition duration-200">Start
                                Building</a>
                            <a href="{{ route('register') }}"
                               class="inline-flex py-4 px-6 items-center justify-center text-lg font-medium text-black hover:text-white border border-teal-900 hover:bg-teal-900 rounded-full transition duration-200">Sign
                                Up for Free</a>
                        </div>
                    @endguest
                    @auth
                ...
                <div class="flex -mx-4 items-end relative">
                    ...
                    <div class="w-2/3 xs:w-1/2 lg:w-auto ml-auto px-4">
                        <img class="block w-1/2 md:w-64 ml-auto rounded-t-2xl"
                             src="https://images.unsplash.com/photo-1603814929877-d5d927322656?crop=entropy&amp;cs=srgb&amp;fm=jpg&amp;ixid=M3wzMzIzMzB8MHwxfHNlYXJjaHwzMXx8Y29uc3RydWN0aW9ufGVufDB8MXx8fDE3Mzk0Njk2NDF8MA&amp;ixlib=rb-4.0.3&amp;q=85&amp;w=1920"
                             alt="">
                    </div>
                    <div
                        class="absolute bottom-0 left-0 w-full py-32 bg-gradient-to-t from-orange-50 to-transparent"></div>
                </div>
            </div>
        </div>
        ...
        <div class="pt-16 pb-24 px-5 xs:px-8 xl:px-12 rounded-3xl">
            <div class="container mx-auto px-4">
                ...
                <div class="border-t pt-14">
                    <h1 class="font-heading text-4xl sm:text-6xl mb-24">Pioneering the Future of Construction
                        Planning</h1>
                    <div class="flex flex-wrap -mx-4">
                        <div class="w-full sm:w-1/2 lg:w-1/4 px-4 mb-12 lg:mb-0">
                            <div>
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                     class="bg-lime-500 rounded-lg w-14 h-14 p-2" viewbox="0 0 16 16">
                        ...
                        <div class="w-full sm:w-1/2 lg:w-1/4 px-4 mb-12 lg:mb-0">
                            <div>
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewbox="0 0 24 24"
                                     class="bg-lime-500 rounded-lg w-14 h-14 p-2">
                                    <path
                        ...
                        <div class="w-full sm:w-1/2 lg:w-1/4 px-4 mb-12 sm:mb-0">
                            <div>
                                ...
                                <div class="mt-6">
                                    ...
                                    <p class="text-gray-700 mb-6">Browse hundreds of products in immersive detail. See
                                        your design come alive with photorealistic models.</p>
                        ...
                        <div class="w-full sm:w-1/2 lg:w-1/4 px-4">
                            <div>
                                ...
                                <div class="mt-6">
                                    ...
                                    <p class="text-gray-700 mb-6">Swap materials and watch costs update in real
                                        time.</p>
        ...
        <div class="py-16 px-4 sm:px-8 bg-orange-50 rounded-3xl">
            <div class="container mx-auto px-4">
                <div class="flex mb-4 items-center">
                    ...
                    <span class="inline-block ml-2 text-sm font-medium text-teal-900">About us</span></div>
                        ...
                        <div class="flex flex-wrap -mx-4">
                            <div class="w-full lg:w-2/3 px-4 mb-12 lg:mb-0">
                                <div class="max-w-xl">
                                    ...
                                    <p class="text-lg text-gray-700">At <strong>BuildVis</strong>, we’re on a mission to
                                        transform the way construction projects are planned and executed. Our platform
                                        is built for anyone who’s ever struggled with budget overruns, design
                                        compromises, or the frustration of outdated planning tools.</p>
                                    <p class="text-lg text-gray-700 mt-3">We’re proud to offer features like
                                        budget-based material suggestions, interactive 3D models, and seamless inventory
                                        integration. But more than that, we’re proud to be a part of your journey to
                ...
                <div class="flex flex-wrap -mx-4">
                    <div class="w-full lg:w-1/2 px-4 mb-16 lg:mb-0">
                        <div class="flex flex-col h-full max-w-sm sm:max-w-lg">
                            <h1 class="font-heading text-4xl sm:text-6xl text-white mb-16">Answers to the frequently
                                asked questions.</h1>
                            <div class="mt-auto">
                                <div class="mb-8">
                    ...
                    <div class="w-full lg:w-1/2 px-4">
                        <div>
                            <button x-data="{ accordion: false }" x-on:click.prevent="accordion = !accordion"
                                    class="flex w-full py-6 px-8 mb-4 items-start justify-between text-left bg-white shadow-md rounded-2xl">
                                <div class="pr-5">
                                    ...
                                    <div x-ref="container"
                                        ...
                                        <p class="text-gray-700 mt-4">BuildVis is an innovative platform that combines
                                            3D modeling, AI-driven budgeting, and e-commerce platform to simplify
                                ...
                                <span class="flex-shrink-0">
                                    <div :class="{ 'hidden': accordion }">
                                        <svg width="24" height="24" viewbox="0 0 24 24" fill="none"
                                             xmlns="http://www.w3.org/2000/svg">
                                            <path d="M12 5.69995V18.3" stroke="#1D1F1E" stroke-width="1.5"
                                                  stroke-linecap="round" stroke-linejoin="round"></path>
                                            <path d="M5.69995 12H18.3" stroke="#1D1F1E" stroke-width="1.5"
                                                  stroke-linecap="round" stroke-linejoin="round"></path>
                                        </svg>
                                    </div>
                            ...
                            <button x-data="{ accordion: false }" x-on:click.prevent="accordion = !accordion"
                                ...
                                <div class="pr-5">
                                    ...
                                    <div x-ref="container"
                                         :style="accordion ? 'height: ' + $refs.container.scrollHeight + 'px' : ''"
                                         class="overflow-hidden h-0 duration-500">
                                        <p class="text-gray-700 mt-4">BuildVis is designed for everyone—homeowners,
                                            architects, contractors, and DIYers. Whether you’re planning a small
                                            renovation or a large-scale construction project, BuildVis has the tools to
                                            help.</p>
                                    </div>
                                </div>
                                <span class="flex-shrink-0">
                            ...
                            <button x-data="{ accordion: false }" x-on:click.prevent="accordion = !accordion"
                                ...
                                <div class="pr-5">
                                    ...
                                    <div x-ref="container"
                                         :style="accordion ? 'height: ' + $refs.container.scrollHeight + 'px' : ''"
                                         class="overflow-hidden h-0 duration-500">
                                        <p class="text-gray-700 mt-4">Yes! BuildVis lets you input your budget and
                                            instantly see how changes affect material selection and costs. You can tweak
                                            your budget and watch the 3D model update in real time.</p>
                                    </div>
                                </div>
                                <span class="flex-shrink-0">
                                    <div :class="{ 'hidden': accordion }">
                            ...
                            <button x-data="{ accordion: false }" x-on:click.prevent="accordion = !accordion"
                                ...
                                <div class="pr-5">
                                    ...
                                    <div x-ref="container"
                                         :style="accordion ? 'height: ' + $refs.container.scrollHeight + 'px' : ''"
                                         class="overflow-hidden h-0 duration-500">
                                        <p class="text-gray-700 mt-4">Yes, BuildVis syncs with real-time inventory to
                                            ensure suggested materials are in stock. If an item is unavailable, you’ll
                                            be notified immediately.</p>
                                    </div>
                                </div>
                                <span class="flex-shrink-0">
                                    <div :class="{ 'hidden': accordion }">
                            ...
                            <button x-data="{ accordion: false }" x-on:click.prevent="accordion = !accordion"
                                ...
                                <div class="pr-5">
                                    ...
                                    <div x-ref="container"
                                         :style="accordion ? 'height: ' + $refs.container.scrollHeight + 'px' : ''"
                                         class="overflow-hidden h-0 duration-500">
                                        <p class="text-gray-700 mt-4">Yes! BuildVis is fully responsive and works on
                                            both desktop and mobile devices. We also offer a mobile app for a seamless
                                            experience.</p>
                                    </div>
                                </div>
                                <span class="flex-shrink-0">
            ...
            <div class="max-w-md md:max-w-2xl lg:max-w-6xl mx-auto">
                <div class="flex flex-wrap items-center justify-center md:justify-between -mx-4">
                    <div class="px-4 order-last md:order-first">
                        <a href="#" x-on:click.prevent="activeSlide = activeSlide &gt; 1 ? activeSlide - 1 : slideCount"
                           class="inline-block mr-4 text-gray-700 hover:text-lime-500">
                            <svg width="32" height="32" viewbox="0 0 32 32" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                                <path d="M24.4 16H7.59998" stroke="currentColor" stroke-width="1.5"
                                      stroke-linecap="round" stroke-linejoin="round"></path>
                                <path d="M16 24.4L7.59998 16L16 7.59998" stroke="currentColor" stroke-width="1.5"
                                      stroke-linecap="round" stroke-linejoin="round"></path>
                            </svg>
                        </a>
                    </div>
                                    ...
                                    <div class="overflow-hidden">
                                        <div :style="'transform: translateX(-' + (activeSlide - 1) * 100 + '%)'"
                                            ...
                                            <div class="flex-shrink-0 px-4 w-full">
                                                <h4 class="text-2xl lg:text-3xl font-medium mb-10">"BuildVis completely
                                                    changed the way I approached building my dream home. The 3D modeling
                                                    feature let me see exactly how everything would look, and the budget
                                                    tool saved me thousands by suggesting affordable alternatives."</h4>
                                                <span class="block text-xl font-medium">Jenny Wilson</span>
                                                <span class="block text-lg text-gray-700">Homeowner</span>
                                            </div>
                                            <div class="flex-shrink-0 px-4 w-full">
                                                <h4 class="text-2xl lg:text-3xl font-medium mb-10">"I’ve always wanted
                                                    to build my own shed, but I didn’t know where to start. BuildVis
                                                    made it so easy—I could play around with designs, stay within my
                                                    budget, and even order materials directly from the platform. It’s
                                                    like having a construction expert in your pocket!"</h4>
                    ...
                    <div class="px-4 order-last">
                        <a href="#" x-on:click.prevent="activeSlide = activeSlide &lt; slideCount ? activeSlide + 1 : 1"
                           class="inline-block text-gray-700 hover:text-lime-500">
                            <svg width="32" height="32" viewbox="0 0 32 32" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                                <path d="M7.59998 16H24.4" stroke="currentColor" stroke-width="1.5"
                                      stroke-linecap="round" stroke-linejoin="round"></path>
                                <path d="M16 7.59998L24.4 16L16 24.4" stroke="currentColor" stroke-width="1.5"
                                      stroke-linecap="round" stroke-linejoin="round"></path>
                            </svg>
                        </a>
                    </div>
    ...
    <section>
        <div class="p-4">
            <div
                class="max-w-xl lg:max-w-5xl mx-auto xl:max-w-none px-5 md:px-12 xl:px-24 py-16 bg-teal-900 rounded-2xl">
                <div class="container mx-auto px-4">
                    <div class="flex flex-wrap items-center -mx-4">
                        <div class="w-full lg:w-2/3 px-4 mb-8 lg:mb-0">
                            <div class="max-w-md xl:max-w-none">
                                <h1 class="font-heading text-4xl xs:text-5xl sm:text-6xl tracking-sm text-white mb-6">
                                    Find Affordable Materials</h1>
                                <p class="text-lg text-white opacity-80">Our commitment to green energy is paving the
                                    way for a cleaner, healthier planet. </p>
                            </div>
                        </div>
                        <div class="w-full lg:w-1/3 px-4 lg:text-right">
                            <a href="{{ route('login') }}"
                               class="inline-flex py-4 px-6 items-center justify-center text-lg font-medium text-teal-900 border border-lime-500 hover:border-white bg-lime-500 hover:bg-white rounded-full transition duration-200">Start
                                Building</a>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="flex flex-wrap -mx-4">
                            <div class="w-1/2 xs:w-1/3 px-4 mb-8 xs:mb-0">
                                ...
                                <ul>
                                    ...
                                    <li class="mb-4"><a
                                            class="inline-block text-white opacity-80 hover:opacity-100 font-medium"
                                            href="#">How it works</a></li>
                                    <li><a class="inline-block text-white opacity-80 hover:opacity-100 font-medium"
                                           href="#">Pricing</a></li>
                                </ul>
                            </div>
                            <div class="w-1/2 xs:w-1/3 px-4 mb-8 xs:mb-0">
