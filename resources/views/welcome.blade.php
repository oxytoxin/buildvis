                ...
                <div class="container mx-auto px-4">
                    <div class="relative flex items-center justify-between">
                        <a href="#" class="inline-block">
                            <img class="h-28" src="images/logo-transparent.png" alt="">
                        </a>
                ...
                <div class="container mx-auto px-4 relative">
                    <div class="max-w-lg xl:max-w-xl mx-auto mb-12 lg:mb-0 text-center">
                        ...
                        <div class="flex flex-col sm:flex-row justify-center">
                            <a href="login.html" class="inline-flex py-4 px-6 mb-3 sm:mb-0 sm:mr-4 items-center justify-center text-lg font-medium text-white hover:text-teal-900 border border-teal-900 hover:border-lime-500 bg-teal-900 hover:bg-lime-500 rounded-full transition duration-200">Start Building</a>
                            <a href="register.html" class="inline-flex py-4 px-6 items-center justify-center text-lg font-medium text-black hover:text-white border border-teal-900 hover:bg-teal-900 rounded-full transition duration-200">Sign Up for Free</a>
                        </div>
                    </div>
        ...
        <section class="relative py-12 lg:py-24 bg-teal-900 overflow-hidden">
            ...
            <div class="container px-4 mx-auto relative">
                <div class="max-w-xl lg:max-w-none mx-auto">
                    ...
                    <div>
                        <p class="text-sm text-gray-500 text-rig text-right">© 2024 BuildVis. All rights reserved.</p>
                    </div>
                </div>
            </div>
        </section>
