            ...
            <div
                ...
                @if($loadedEstimate)
                    ...
                    @else
                        ...
                        <div id="estimate" class="space-y-4 p-8 text-[100px]">
                            ...
                            <div class="space-y-4">
                                @foreach ($quotation['itemized_costs'] as $itemized_cost)
                                    <div
                                        class="bg-white dark:bg-gray-800 rounded-lg break-after-page">
                                        <div class="px-4 py-3 border border-gray-200 dark:border-gray-600">
                                        ...
                                        <div class="overflow-x-auto">
                                            <table
                                                class="min-w-full !my-0 divide-y divide-gray-200 dark:divide-gray-700">
